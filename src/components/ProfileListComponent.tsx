        ...
        <>
            <div className="profile-list">
                <div className="profile-list__text">
                    <input className="profile-list__search" type="text" placeholder="search by username" 
                    name="username" id="username" onChange={handleInputChange}></input>
                    <input className="profile-list__checkbox" type="checkbox" id="hideUnemployed" name="hideUnemployed" onClick={handleHideClick}></input>
                    <label htmlFor="hideUnemployed"> Hide unemployed users</label>
